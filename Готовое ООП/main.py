...
best_lecturer_1 = Lecturer('Nikita', 'Drozdov')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Evgeniy', 'Chabanov')
best_lecturer_2.courses_attached += ['Java']

best_lecturer_3 = Lecturer('Ivan', 'Markelov')
...
student_2.rate_hw(best_lecturer_2, 'Java', 4)

student_3.rate_hw(best_lecturer_3, 'Python', 1)
...
cool_reviewer_1.rate_hw(student_1, 'Python', 3)

cool_reviewer_2.rate_hw(student_2, 'Java', 6)
cool_reviewer_2.rate_hw(student_2, 'Java', 9)
cool_reviewer_2.rate_hw(student_2, 'Java', 1)
